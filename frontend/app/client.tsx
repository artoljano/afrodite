...
export default function HomeClient() {
  ...
  return (
    <div className="flex flex-col w-full">
      {/* JSON-LD for FAQ on the homepage */}
      ...
      <section className="relative bg-afrodite-creme">
        ...
        <VideoBackground
          ...
          overlayOpacity={0.4}
          className="min-h-[60vh] md:min-h-[70vh] py-0 md:py-24 bg-afrodite-creme relative flex items-center"
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            <div ref={whyUsRef} className="space-y-6">
              ...
              >
                {[
                  {
                    icon: <Award className="h-8 w-8 text-afrodite-creme" />,
                    title: "Çertifikime Ndërkombëtare",
                    desc: "Kurset tona ofrojnë certifikime të njohura ndërkombëtarisht që ju ndihmojnë të avanconi karrierën tuaj kudo në botë.",
                  },
                  {
                    icon: (
                      <GraduationCap className="h-8 w-8 text-afrodite-creme" />
                    ),
                    title: "Programe profesionale 2-3 vjecare",
                    desc: "Diploma italiane që ofrojnë mundësinë për të hapur sallonin tuaj në Itali dhe në çdo vënd të BE dhe të punoni ligjërisht në BE, USA, Kanada dhe Australi.",
                  },
                  {
                    icon: <Users className="h-8 w-8 text-afrodite-creme" />,
                    title: "Instruktorë Profesionistë",
                    desc: "Mësoni nga instruktorë me përvojë ndërkombëtare që janë ekspertë në fushat e tyre dhe të përkushtuar ndaj suksesit tuaj.",
                  },
                  {
                    icon: <BookOpen className="h-8 w-8 text-afrodite-creme" />,
                    title: "Kurrikula Moderne",
                    desc: "Çdo program është ndërtuar mbi baza aktuale dhe praktike, të përditësuara sipas tregut të punës.",
                  },
                  {
                    icon: <Users className="h-8 w-8 text-afrodite-creme" />,
                    title: "Komunitet Mbështetës",
                    desc: "Bëhuni pjesë e një komuniteti mbështetës profesionistësh dhe studentësh që ndajnë pasionin për zhvillim personal dhe profesional.",
                  },
                ].map((item, idx) => (
                  <motion.div
                    key={item.title}
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-afrodite-lightPurple">{item.desc}</p>
                      </div>
                    </div>
                  </motion.div>
                ))}
      ...
      <section className="bg-afrodite-creme py-16 md:py-24 relative overflow-hidden">
        ...
        <div ref={statsRef} className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                icon: <Award className="h-10 w-10 text-afrodite-creme" />,
                end: 2500,
                label: "Studentë të Certifikuar",
                barWidth: "85%",
                delay: 0.1,
              },
              {
                icon: <BookOpen className="h-10 w-10 text-afrodite-creme" />,
                end: 60,
                label: "Kurse Profesionale",
                barWidth: "65%",
                delay: 0.2,
              },
              {
                icon: <Users className="h-10 w-10 text-afrodite-creme" />,
                end: 15,
                label: "Instruktorë të Kualifikuar",
                barWidth: "75%",
                delay: 0.3,
              },
              {
                icon: <Calendar className="h-10 w-10 text-afrodite-creme" />,
                end: 20,
              ...
              >
                ...
                <div className="p-8 text-center">
                  ...
                  <CountUpAnimation
                    ...
                    inView={statsInView}
                  />
                  <p className="text-afrodite-lightPurple">{s.label}</p>
