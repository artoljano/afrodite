...
export const partners: Partner[] = [
    ...
    //Pa pershkrim
  // {
  //   emri: "2 Western Balkan",
  //   industria: "Nismë Rajonale",
  //   pershkrimi: "",
  //   cardPicture: "/partners/2-western_balkan.webp",
  //   logoImg: "/partners/2-western_balkan.webp",
  // },

  {
    ...
    cardPicture: "/partners/alternative-pro.webp",
    logoImg: "/partners/alternative-pro.webp",
  },

  {
    ...
    pershkrimi: "",
    cardPicture: "/partners/CAT.webp",
    logoImg: "/partners/CAT.webp",
  },
  //   {
  //   emri: "Levizja për Gratë",
  //   industria: "Shoqatë / Nismë",
  //   pershkrimi: "",
  //   cardPicture: "/partners/levizja-grate.webp",
  //   logoImg: "/partners/levizja-grate.webp",
  // },
  // {
  //   emri: "Luiza Hair",
  //   industria: "Parukeri",
  ...
  //   cardPicture: "/team/luiza.webp",
  //   logoImg: "/partners/luiza-hair.webp",
  // },
    {
    emri: "Mumi",
    industria: "Sallon Bukurie",
    pershkrimi: "Mumi Cosmetics Albania ofron një gamë të gjerë produktesh bukurie dhe kozmetike me përbërës natyralë dhe teknologji moderne, për trajtime profesionale dhe shtëpiake, duke garantuar cilësi të lartë dhe rezultate të dukshme.",
    cardPicture: "/partners/mumi-card.webp",
    logoImg: "/partners/mumi-logo.webp",
  },
{
  emri: "StarPlus TV Shkoder",
  industria: "Media & Televizion",
  pershkrimi: "StarPlus TV Shkodër është një kanal televiziv rajonal që ofron programe informative, kulturore dhe argëtuese për komunitetin e Shkodrës e më gjerë. Me lajme, intervista dhe dokumentarë, ai promovon traditat lokale dhe ngjarjet kryesore të rajonit.",
  cardPicture: "/partners/star-card.webp",
  logoImg: "/partners/star-plus-tv.webp",
},
...
//   cardPicture: "",
//   logoImg: "/partners/arts-hair-sallon.webp",
// },
//  {
...
// },

  {
    ...
    cardPicture: "/partners/dhkz-card.webp",
    logoImg: "/partners/dhoma-zytarise.webp",
  },
{
  emri: "Fortis Balkan University of Wellness",
  ...
  cardPicture:  "/partners/gruppo-fortis.webp",
  logoImg: "/partners/gruppo-fortis.webp",
},
{
  emri: "Xheti Style Berber",
  industria: "Berber",
  pershkrimi:
    "Përvoja e tij filloi në një moshë të re, në një nga dyqanet më të njohura të qytetit të tij. Pas dy vitesh përvojë atje, ai vendosi të ndjekë një shkollë më të avancuar në këtë drejtim. Më pas u transferua në Belgjikë, ku vazhdoi rrugëtimin e tij profesional. Për katër vite pas diplomimit, Xheti punoi dhe përmirësoi më tej aftësitë e tij, derisa vendosi të rikthehej në vendlindje. Sot, ai është i njohur në qytetin dhe shtetin e tij si themelues i dy bizneseve të ndërtuara me punë të palodhur dhe përkushtim të vazhdueshëm.",
  cardPicture: "/partners/barber-kosova-card.webp",
  logoImg: "/partners/xheti-kosove.webp",
},
  // {
  ...
  //   cardPicture: "",
  //   logoImg: "/partners/mihi-milano.webp",
  // },
  ...
  cardPicture:"/partners/uet-logo.webp",
  logoImg: "/partners/uet-logo.webp",
},
  {
  emri: "Violeta Aesthetics",
  industria:
  ...
  cardPicture:"/partners/logo-violeta.webp",
  logoImg: "/partners/logo-violeta.webp",
},
  {
  emri: "Ray Medic Clinic and Beauty",
  ...
  cardPicture: "/partners/logo-raymed.webp",
  logoImg: "/partners/logo-raymed.webp",
},
...
//   cardPicture: "",
//   logoImg: "/partners/mira-beauty.webp",
// },
  {
...

{
    ...
    cardPicture: "/partners/starform-logo.webp",
    logoImg: "/partners/starform-logo.webp",
  },
  {
  ...
  cardPicture: "/partners/daljani.webp",
  logoImg: "/partners/daljani.webp",
},
{
  ...
  cardPicture: "/partners/fiam-logo.webp",
  logoImg: "/partners/fiam-logo.webp",
},
// {
...
//   cardPicture: "/team/eni.webp",
//   logoImg: "/team/eni.webp",
// },
...
//no info
{
  ...
  cardPicture:"/partners/tnt-cosmetics.webp",
  logoImg: "/partners/tnt-cosmetics.webp",
},

{
  ...
  cardPicture: "/partners/concept-p.webp",
  logoImg: "/partners/concept-p.webp",
},
{
  ...
  cardPicture:  "/partners/prime-extension.webp",
  logoImg: "/partners/prime-extension.webp",
},
// {
